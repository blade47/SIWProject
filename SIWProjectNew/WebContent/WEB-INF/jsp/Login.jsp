		...
		<!-- Main -->
			<section id="main">
        		<form action="login" method="post">
        					<div align="center"><label>${erroreDatiImmessi}</label></div>
        					&nbsp;        		       
                    		<div align="center"><label>User Name: </label><input type="text" name="username"></div>  
                    		<div align="center"><label><form:errors path="login.username" cssClass="error" /></label></div>  
                    		       
                    		<div align="center"><label>Password: </label><input type="password" name="password"></div>
                    		<div align="center"><label><form:errors path="login.password" cssClass="error" /></label></div>  
                			&nbsp;
