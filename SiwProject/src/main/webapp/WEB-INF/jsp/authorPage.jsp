				...
				<!-- Header -->
					<header id="header">
						...
						<ul class="icons">
							...
							<li><a href="<c:url value="sendMail?to=${author.email}"/>" class="icon style2 fa-envelope-o"><span class="label">Email</span></a></li>
						</ul>
						<sec:authorize access="hasAuthority('Administrator')">	
							<input type="button" class="small" onclick="location.href='<c:url value="deleteUser?userID=${author.id}" />';" value="Elimina Utente" />
						</sec:authorize>
					</header>					
