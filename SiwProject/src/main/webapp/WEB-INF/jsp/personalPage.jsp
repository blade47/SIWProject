			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<h1>Ciao <sec:authentication property="principal.username"/>, ecco le tue foto</h1>
					</header>
									...
									%>
							   		...
							   		<c:forEach var="photo" items="${photos}"> 							
											...
											<div style="inline-block;margin-bottom: 50px;">
												<input type="button" class="small" onclick="location.href='<c:url value="deletePhoto?id=${photo.id}" />';" value="Elimina" />
							   				</div>
